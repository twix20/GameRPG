...
insert into BattlefieldActionsHistory(Id, ActionDate, ActionDescription, Battlefield_Id, ActionBy_Player_Id) values (1, to_date('11/02/2016', 'dd/mm/yyyy'), 'Test ActionDescription1', 1, 1);
insert into BattlefieldActionsHistory(Id, ActionDate, ActionDescription, Battlefield_Id, ActionBy_Player_Id) values (2, to_date('12/02/2016', 'dd/mm/yyyy'), 'Test ActionDescription2', 1, 1);
insert into BattlefieldActionsHistory(Id, ActionDate, ActionDescription, Battlefield_Id, ActionBy_Player_Id) values (3, to_date('13/02/2016', 'dd/mm/yyyy'), 'Test ActionDescription3', 1, 1);
insert into BattlefieldActionsHistory(Id, ActionDate, ActionDescription, Battlefield_Id, ActionBy_Player_Id) values (4, to_date('11/03/2016', 'dd/mm/yyyy'), 'Test ActionDescription4', 2, 1);